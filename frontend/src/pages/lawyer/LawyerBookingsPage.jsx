        ...
        row.status === "COMPLETED" ? (
          row.dispute ? (
            <button
              ...
              className="inline-flex items-center gap-2 rounded-lg border border-card-border bg-surface px-2.5 py-1.5 text-left transition-colors hover:bg-surface-hover hover:border-primary-border"
            >
    ...
    <PageShell>
      ...
      >
        <DataTable
          ...
          emptyDescription="New consultations will appear here."
        />
      </DataList>
