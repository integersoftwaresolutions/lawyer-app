        ...
        {SUGGESTIONS.map((item) => {
          ...
          return (
            <button
              ...
              className="flex items-center gap-3 w-full text-left px-4 py-3 rounded-xl border border-card-border bg-card hover:bg-surface-hover hover:border-primary-border transition-colors text-sm text-text-secondary hover:text-text-primary"
            >
